 ...
 * @internal
 */
class FiltrosDiaADiaForm extends FormBase {

  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'filtros_dia_a_dia_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $padres = ProductoController::padres_dia_a_dia();
